...
write_csv(combined_df,here("decontam","Output_csv","pre_occupancy_results_sum.taxonomy_tech_reps_summed_read_counts.csv"))
```
### Output eDNA Index
```{r}
...
write_csv(pre_wide_reads ,here("decontam","Output_csv","pre_occ_site_sum.taxonomy_reads_summed.csv"))
...
write_csv(pre_wide,here("decontam","Output_csv","pre_occ_site_averaged_sum.taxonomy_e_index.csv"))
```
...
write_csv(post_wide_reads ,here("decontam","Output_csv","post_occ_site_sum.taxonomy_reads_summed.csv"))
...
write_csv(post_wide,here("decontam","Output_csv","post_occ_site_averaged_sum.taxonomy_e_index.csv"))
```
